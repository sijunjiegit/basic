                ...
                <div id="pad-wrapper" class="users-list">
                    ...
                    <div class="row-fluid table">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <!-- row -->
				<?php foreach ($userList as $manage) { ?>
                                <tr>
                                    <td><?= $manage->adminid ?></td>
                                    <td><?= $manage->adminuser ?></td>
                                    <td><?= $manage->adminemail ?></td>
                                    <td><?= date('Y-m-d H:i:s', $manage->logintime) ?></td>
                                    <td><?= long2ip($manage->loginip) ?></td>
                                    <td><?= date('Y-m-d H:i:s', $manage->createtime) ?></td>
                                    <td class="align-right">
                                        <a href="<?= yii\helpers\Url::to(['manage/del', 'adminid'=>$manage->adminid]) ?>">删除</a></td>
                                </tr>
				<?php } ?>
                            </tbody>
                        </table>
