    ...
    <body>
        ...
        <div class="content">
		    ...
		    ?>
				    ...
				    <?= $form->field($model, 'confirmadminpass')->passwordInput(['class'=>'span9'])  ?>
                                    <div class="span11 field-box actions">
					<?= yii\helpers\Html::submitButton('修改', ['class' => 'btn-glow primary']) ?>
                                        <span>或者</span>
					<?= yii\helpers\Html::resetButton('创建', ['class' => 'reset']) ?>
