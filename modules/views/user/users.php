				...
				<?php if (false == empty($users)) { ?>
			        <?php foreach ($users as $user) { ?>
                                <tr class="first">
                                    ...
                                    <td><?= $user->profile->truename ? $user->profile->truename : '未填写'?></td>
                                    <td><?= $user->profile->nickname ? $user->profile->nickname : '未填写'?></td>
                                    <td>
					<?php 
					...
					?>
                                    ...
                                    <td><?= $user->profile->age ? $user->profile->age : '未填写' ?></td>
                                    <td><?= $user->profile->brithday ? $user->profile->brithday : "未填写" ?></td>
