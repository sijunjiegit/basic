        ...
        <div class="content">
		    ...
		    ?>
				...
				?>
					...
					<?= $form->field($model, 'useremail')->textInput(['class' => 'span9']);?>
                                    </div>
                                    <div class="form-group field-user-userpass">
					<?= $form->field($model, 'userpass')->passwordInput(['class' => 'span9']);?>
                                    </div>
                                    <div class="form-group field-user-repass">
					<?= $form->field($model, 'confirmuserpass')->passwordInput(['class' => 'span9']);?>
                                    </div>
