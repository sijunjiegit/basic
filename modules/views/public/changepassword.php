...
<body>
    ...
    <a class="brand" href="<?php echo yii\helpers\Url::to(['/index/index']) ?>"></a>
		...
		?>
                <?php echo $form->field($model, 'adminuser')->hiddenInput(['value'=>$adminuser]); ?>
                <?php echo $form->field($model, 'adminpass')->passwordInput(["class" => "span12", "placeholder" => "新密码"]); ?>
                <?php echo $form->field($model, 'confirmadminpass')->passwordInput(["class" => "span12", "placeholder" => "确认密码"]); ?>
